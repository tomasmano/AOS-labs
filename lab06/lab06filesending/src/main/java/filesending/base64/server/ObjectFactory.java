 ...
 * generated in the filesending.base64.server package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: filesending.base64.server
     * 
     */
