...
@WebServiceClient(name = "ConcatWSDL", 
                  wsdlLocation = "file:/home/tomy/NetBeansProjects/AOS-labs/lab08/concat.xml",
...
public class ConcatWSDL extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/tomy/NetBeansProjects/AOS-labs/lab08/concat.xml");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/home/tomy/NetBeansProjects/AOS-labs/lab08/concat.xml");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
